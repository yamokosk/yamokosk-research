function [minlevel, maxlevel] = dHashSpaceGetLevels(SpaceID)
...
mptr = libpointer( 'mHashLevels', calllib('MODE','mHashSpaceGetLevels',SpaceID) );
m = get(mptr, 'Value');
minlevel = m.minLevel;
maxlevel = m.maxLevel;
calllib('MODE','mDeallocateHashLevels',mptr);