...
%   collision. A function such as Collide could then be used to determine
%   more detail information about the contact for each pair.
%
%   Example
%      CreateBubbleWorld()
%
...
CollisionPairs = calllib('MODE','mSpaceCollide2',SpaceID1, SpaceID2)';