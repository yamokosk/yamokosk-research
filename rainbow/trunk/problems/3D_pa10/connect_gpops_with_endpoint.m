function [T, U, X, exitflag, exitmsg] = connect_gpops_with_endpoint(tspan, x0, xf, x_lb, x_ub, u_lb, u_ub, udata)

global CONSTANTS;

% Bounds on states and controls used later to scale the optimization problem.
bounds = struct('x_lb', x0, ...
                'x_ub', xf, ...
                'u_lb', u_lb, ...
                'u_ub', u_ub, ...
                't_lb', tspan(1), ...
...
% Functions structure
funcs = struct('cost', 'cost_gpops_with_endpoint', 'dae', 'dae_gpops');
