function [T, U, X, exitflag, exitmsg] = connect_gpops_no_endpoint_unscaled(tspan, x0, xf, x_lb, x_ub, u_lb, u_ub, udata)
...
% Functions structure
funcs = struct('cost', 'cost_gpops_no_endpoint_unscaled', 'dae', 'dae_gpops_unscaled');
